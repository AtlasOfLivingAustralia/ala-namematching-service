...
```groovy
compile "au.org.ala.names:ala-namematching-client:1.8.2"
```
...
1. Start application with `java -jar target/ala-name-matching-server-1.8.2.jar server config-local.yml`
