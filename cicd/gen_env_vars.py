...
parser.add_argument(
    "--env", "-e", help="The environment we are running in", required=True
)
parser.add_argument(
    "--conf",
    "-c",
...
parser.add_argument(
    "--clean-branch",
    "-cb",
    help="The clean branch name, used for resource naming",
    required=True,
)
...
config = configparser.ConfigParser(
    defaults=config_defaults, interpolation=configparser.ExtendedInterpolation()
)
